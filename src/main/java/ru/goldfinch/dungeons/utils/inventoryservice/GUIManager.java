...
import ru.goldfinch.dungeons.utils.inventoryservice.opener.ChestInventoryOpener;
import ru.goldfinch.dungeons.utils.inventoryservice.opener.InventoryOpener;
import ru.goldfinch.dungeons.utils.inventoryservice.opener.SpecialInventoryOpener;
...
public class GUIManager {
    ...
    private final Map<UUID, GUI> inventories;
    ...
    public List<Player> getOpenedPlayers(GUI inv) {
    ...
    public Optional<GUI> getInventory(Player p) {
        return Optional.ofNullable(this.inventories.get(p.getUniqueId()));
    }

    protected void setInventory(Player p, GUI inv) {
        if (inv == null)
    ...
    public void handleInventoryOpenError(GUI inventory, Player player, Exception exception) {
        inventory.close(player);

        Bukkit.getLogger().log(Level.SEVERE, "Error while opening SmartInventory:", exception);
    }

    public void handleInventoryUpdateError(GUI inventory, Player player, Exception exception) {
        inventory.close(player);
    ...
    class InvListener implements Listener {
        ...
        public void onInventoryClick(InventoryClickEvent e) {
            ...
            if (clickedInventory == p.getOpenInventory().getTopInventory()) {
                ...
                GUI inv = inventories.get(p.getUniqueId());
                ...
                inv.getListeners().stream()
                        ...
                        .forEach(listener -> ((GUIListener<InventoryClickEvent>) listener).accept(e));
        ...
        public void onInventoryDrag(InventoryDragEvent e) {
            ...
            inv.getListeners().stream()
                    ...
                    .forEach(listener -> ((GUIListener<InventoryDragEvent>) listener).accept(e));
        }
        ...
        public void onInventoryOpen(InventoryOpenEvent e) {
            ...
            inv.getListeners().stream()
                    ...
                    .forEach(listener -> ((GUIListener<InventoryOpenEvent>) listener).accept(e));
        }
        ...
        public void onInventoryClose(InventoryCloseEvent e) {
            ...
            inv.getListeners().stream()
                    ...
                    .forEach(listener -> ((GUIListener<InventoryCloseEvent>) listener).accept(e));
        ...
        public void onPlayerQuit(PlayerQuitEvent e) {
            ...
            inv.getListeners().stream()
                    ...
                    .forEach(listener -> ((GUIListener<PlayerQuitEvent>) listener).accept(e));
        ...
        public void onPluginDisable(PluginDisableEvent e) {
            new HashMap<>(inventories).forEach((player, inv) -> {
                inv.getListeners().stream()
                        ...
                        .forEach(listener -> ((GUIListener<PluginDisableEvent>) listener).accept(e));
